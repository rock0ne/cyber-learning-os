...
object LearningGuide {
    ...
    val steps = listOf(
        LearningStepGuide(1, "Orient", "Define the learning outcome",
            "Decide what you must be able to do, not merely what you intend to read.",
            "A visible performance target stops completion from being confused with competence.",
        ...
        LearningStepGuide(2, "Orient", "Establish purpose",
        ...
        LearningStepGuide(3, "Orient", "Schedule the learning",
        ...
        LearningStepGuide(4, "Prime", "Prime before intensive study",
        ...
        LearningStepGuide(5, "Prime", "Find the gist",
        ...
        LearningStepGuide(6, "Build & Connect", "Protect working memory",
            "Deliberately remove distractions and reduce simultaneous cognitive demands.",
            "Reasoning depends on limited working memory; context switching spends it before integration occurs.",
        ...
        LearningStepGuide(7, "Build & Connect", "Prioritise relationships",
        ...
        LearningStepGuide(8, "Build & Connect", "Use relational notes",
        ...
        LearningStepGuide(9, "Build & Connect", "Choose learning order intelligently",
        ...
        LearningStepGuide(10, "Build & Connect", "Follow the confusion compass",
        ...
        LearningStepGuide(11, "Perform", "Match learning to real performance",
            "Practise the work the target role actually performs: investigate, decide, and communicate under constraints.",
            "Recognition exercises do not establish the ability to act on ambiguous technical evidence.",
        ...
        LearningStepGuide(12, "Perform", "Attempt before getting help",
            "Commit to a complete unaided attempt before opening documentation, AI, hints, or a solution.",
            "An attempt exposes your actual model; immediate help can create fluency without revealing gaps.",
        ...
        LearningStepGuide(13, "Retain & Communicate", "Test strategically",
            "Retrieve and apply the topic after enough delay for some forgetting to occur.",
            "Effortful delayed retrieval strengthens access and reveals knowledge that only felt familiar.",
        ...
        LearningStepGuide(14, "Retain & Communicate", "Reproduce real conditions",
            "Progressively remove support and add the uncertainty, time pressure, and communication demands of real work.",
            "Competence must survive outside the generous conditions under which it was learned.",
